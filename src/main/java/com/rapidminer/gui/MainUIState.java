...
public interface MainUIState extends MenusUI, ProcessState {
	...
	Action getImportDataAction();

	Action getProcessImport();
	Action getProcessExport();
	...
	Action getNewPerspective();

	Action getManageConfigurables();
	...
	Action getTutorialAction();

	Action getBrowseVideos();
	Action getBrowseDocumentation();
	Action getBrowseCommunity();
	Action getBrowseSupport();
