...
//				}
				...
				if (isChanged()) {
					...
					if (!relaunch) { // in this case we have already confirmed
                        ...
                        if (getProcessState() == Process.PROCESS_STATE_RUNNING
                            ...
                            final int answer = ConfirmDialog.showConfirmDialog(ApplicationFrame.getApplicationFrame(), "exit",
			...
			public void setTitle() {
				...
				if (this.process != null) {
					...
					if (process.getRepositoryLocation() != null) {
						...
						MainFrame.this.setTitle(locString + (isChanged() ? "*" : "") + " \u2013 " + TITLE + hostname);
					} else {
						MainFrame.this.setTitle("<new process" + (isChanged() ? "*" : "") + "> \u2013 " + TITLE + hostname);
					}
				} else {
	...
	@Override
	public Action getRestorePerspectiveAction() {
		return state.getRestorePerspectiveAction();
	}
	...
	public Action getNewAction() {
		return state.getNewAction();
	}

	@Override
	public Action getOpenAction() {
		return state.getOpenAction();
	}

	@Override
	public Action getSaveAsAction() {
		return state.getSaveAsAction();
	}

	@Override
	public Action getImportDataAction() {
		return state.getImportDataAction();
	}

	@Override
	public Action getProcessImport() {
		return state.getProcessImport();
	}

	@Override
	public Action getProcessExport() {
		return state.getProcessExport();
	}

	@Override
	public Action getUndo() {
		return state.getUndo();
	}

	@Override
	public Action getRedo() {
		return state.getRedo();
	}
	...
	public Action getValidateAction() {
		return state.getValidateAction();
	}

	@Override
	public Action getAutoWire() {
		return state.getAutoWire();
	}

	@Override
	public Action getNewPerspective() {
		return state.getNewPerspective();
	}

	@Override
	public Action getManageConfigurables() {
		return state.getManageConfigurables();
	}

	@Override
	public Action getExportAction() {
		return state.getExportAction();
	}
	...
	public Action getSettingsAction() {
		return state.getSettingsAction();
	}

	@Override
	public Action getTutorialAction() {
		return state.getTutorialAction();
	}

	@Override
	public Action getBrowseVideos() {
		return state.getBrowseVideos();
	}

	@Override
	public Action getBrowseDocumentation() {
		return state.getBrowseDocumentation();
	}

	@Override
	public Action getBrowseCommunity() {
		return state.getBrowseCommunity();
	}

	@Override
	public Action getBrowseSupport() {
		return state.getBrowseSupport();
	}

	@Override
	public Action getAboutAction() {
		return state.getAboutAction();
	}
