...
public class ActionsGlobalSearchManager extends AbstractGlobalSearchManager {
	...
	protected List<Document> createInitialIndex(final ProgressThread progressThread) {
		...
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getNewAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getOpenAction()));
		mainFrameActions.add(createDocument(RapidMinerGUI.getMainFrame().getSaveAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getSaveAsAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getImportDataAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getProcessImport()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getProcessExport()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getUndo()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getRedo()));
		mainFrameActions.add(createDocument(RapidMinerGUI.getMainFrame().getRunAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getStopAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getValidateAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getAutoWire()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getNewPerspective()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getManageConfigurables()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getExportAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getExitAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getSettingsAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getRestorePerspectiveAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getTutorialAction()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getBrowseVideos()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getBrowseDocumentation()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getBrowseCommunity()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getBrowseSupport()));
		mainFrameActions.add(createDocument((ResourceAction) RapidMinerGUI.getMainFrame().getAboutAction()));
